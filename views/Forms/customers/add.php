...
$form   ->field("cus_middle_name")
        ->addClass('inputtext')
        ->placeholder($this->lang->translate('Middle Name'))
        ->autocomplete('off')
        ->value( !empty($this->item['middle_name'])? $this->item['middle_name']:'' );
...
$form   ->field("cus_company_id")
        ->label($this->lang->translate('Company'))
        ->addClass('inputtext')
