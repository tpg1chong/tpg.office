...
$form   ->field("position_name")
        ->label($this->lang->translate('Position name'))
        ->addClass('inputtext')
        ->placeholder('Add Name')
        ->value( !empty($this->item['name'])? $this->item['name']:'' );


$form   ->field("position_description")
...
# set form
$arr['form'] = '<form class="js-submit-form" method="post" action="'.URL. 'people/save_position"></form>';
