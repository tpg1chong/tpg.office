...
<div id="mainContainer" class="clearfix" data-plugins="main">
	...
	<div class="profile-left" role="left" data-width="300">
	    ...
	    <ul class="nav" style="box-shadow: rgba(255, 255, 255, .5) 0px 1px 0px 0px;border-bottom: 1px solid rgb(211, 211, 211);"><?php  
	    	...
	    	echo '<li'.$cls.'><a href="'.URL.'manage/property/'.$this->item['id'].'/'.$value['section'].'">'.$value['label'].'</a></li>';
	    ...
	    <div class="mvm">
	    	<a style="width: 100%;text-align: left;" class="btn btn-red" href="<?=URL?>property/del/<?=$this->item['id']?>" data-plugins="dialog"><i class="icon-trash-o mrs"></i><span>Delete</span></a>
	    </div>
