	...
	<div ref="actions" class="listpage2-actions">
		<div class="clearfix mbs mtm">
			...
			<ul class="lfloat" ref="actions">
				<li class="mt">
					<h2><i class="icon-home mrs"></i><span><?=$this->lang->translate('Property')?></span></h2>
				</li>
				...
				<li class="mt"><a class="btn btn-blue" data-plugins="dialog" href="<?=URL?>properties/add_property"><i class="icon-plus mrs"></i><span><?=$this->lang->translate('Add New')?></span></a></li>
