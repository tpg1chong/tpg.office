		...
		<div class="forum-left-header" role="leftHeader" style="">
			...
			<form class="forum-left-form-wrap" data-action="search">
				...
				<ul class="forum-left-form-filters clearfix">
					<li style="display: none;">Total: <span class="fwb" data-text="total">0</span> results</li>
					<li class="rfloat">
	...
	<div class="forum-content hasLeft has-empty" role="content">
		...
		<div role="toolbar" class="forum-toolbar">
			...
			<nav class="forum-toolbar-nav">
				...
				<a class="forum-toolbar-navItem" data-action-tab="client"><i class="icon-user-circle-o mrs"></i><span>Client</span><span class="mls hidden_elem">[<span data-profile="clientTotal ">0</span>]</span></a>
			</nav>
		</div>
		...
		<div class="forum-profile-wrap" role="main">
			...
			<div class="forum-profile-content has-loading" style="max-width: 750px">
