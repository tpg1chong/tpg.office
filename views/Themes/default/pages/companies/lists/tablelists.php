...
if( !empty($this->results['lists']) ){ 
    ...
    foreach ($this->results['lists'] as $i => $item) { 
        ...
        $tr .= '<tr class="'.$cls.'" data-id="'.$item['id'].'">'.
            ...
            '<td class="type"><ul class="fsm ui-status">'.$item['group_name'].'</ul></td>'.
            
            '<td class="actions"><div class="group-btn whitespace"><a class="btn" data-plugins="dialog" href="'.URL.'companies/edit/'.$item['id'].'"><i class="icon-pencil"></i></a><a class="btn" data-plugins="dialog" href="'.URL.'companies/del/'.$item['id'].'"><i class="icon-trash"></i></a>
                </div></td>'.
