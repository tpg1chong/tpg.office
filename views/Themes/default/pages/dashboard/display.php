		...
		<div ref="calendarHead" style="position: fixed;top: 48px;right: 17px;left: 300px;z-index: 100;background-color: #f2f2f2">
			...
			<div class="pam clearfix">
				...
				<div class="rfloat group-btn mls">
					<a class="btn btn-blue" data-plugins="dialog" href="<?=URL?>events/add"><i class="icon-plus mrs"></i><?=Translate::val('Create')?></a><a class="btn btn-no-padding"><i class="icon-ellipsis-v"></i></a>
				</div>
